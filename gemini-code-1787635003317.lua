-- Banana Cat Hub - Blox Fruit (Compact Size & Custom Icon)
...
----------------------------------------------------------------
-- 1. NÚT BẤM BẬT/TẮT MENU (TOGGLE BUTTON)
----------------------------------------------------------------
local ToggleBtn = Instance.new("ImageButton")
ToggleBtn.Name = "ToggleButton"
ToggleBtn.Size = UDim2.new(0, 45, 0, 45) -- Thu nhỏ nhẹ nút Toggle
ToggleBtn.Position = UDim2.new(0, 15, 1, -70)
...
----------------------------------------------------------------
-- 2. KHUNG MENU CHÍNH (ĐÃ THU NHỎ KÍCH THƯỚC)
----------------------------------------------------------------
local MainFrame = Instance.new("Frame")
MainFrame.Name = "MainFrame"
MainFrame.Size = UDim2.new(0, 500, 0, 290) -- Đã thu nhỏ gọn hơn (500x290)
...
Sidebar.Size = UDim2.new(0, 165, 1, -34)
...
SearchFrame.Size = UDim2.new(1, -10, 0, 24)
...
TabScroll.Size = UDim2.new(1, -4, 1, -34)
...
ContentPanel.Size = UDim2.new(1, -183, 1, -34)
ContentPanel.Position = UDim2.new(0, 177, 0, 28)
...
local function AddButton(tabData, text, callback)
    ...
    BtnFrame.Size = UDim2.new(1, -4, 0, 32)
...
----------------------------------------------------------------
-- 3. BẢNG THÔNG BÁO (NOTIFICATION POPUP)
----------------------------------------------------------------
local NotifFrame = Instance.new("Frame")
NotifFrame.Name = "Notification"
NotifFrame.Size = UDim2.new(0, 290, 0, 75)
NotifFrame.Position = UDim2.new(1, -305, 1, -85)
...
NotifIcon.Image = ICON_ASSET -- Dùng asset mới
