-- https://discord.gg/hs7sWSzzak


shared.LoaderTitle = "join discord cho tôi";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxthumb://type=Asset&id=110625942841371&w=150&h=150",
...
local v8 = CreateObject("TextLabel", {
    ...
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "Youtube: BOMAYYEUVIETNAMCLOUD",
...
local v15 = v14:CreateWindow({
    Title = "BOMAYYEUVIETNAM Hub",
    SubTitle = "menu cổ đại",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
        ...
        while task.wait() do
            pcall(function()
                if game.Workspace.Map:FindFirstChild("MysticIsland") then
                    MirageStatus = "có nhá may mắn đấy";
                else
                    MirageStatus = "đếch có";
                end
            end);
        end
    end);
...
v14:Notify({
    Title = "BOMAYYEUVIETNAM Hub",
    Content = "Load  Xong r mòi thượng đế sài",
    Duration = 10
});